...
export default function AmenityDirectory() {
  ...
  const handleAddAmenity = async (e) => {
    ...
    try {
      ...
      alert(
        "Failed to add facility: " + (err.response?.data?.error || err.message),
      );
    }
  };
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="p-6 border-b border-gray-100 flex justify-between items-center">
        ...
        <button
          ...
          className="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm hover:bg-blue-700 transition-colors"
        >
            ...
            {loading ? (
              ...
              <tr>
                <td
                  ...
                  className="text-center py-8 italic text-gray-400"
                >
                  No facilities registered on the grid.
                </td>
              </tr>
            ) : (
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-md p-8 relative">
            ...
            <h3 className="text-xl font-bold mb-6 italic uppercase tracking-tighter flex items-center">
              <Building className="w-5 h-5 mr-2 text-blue-600" /> Register
              Facility
            </h3>
            ...
            <form onSubmit={handleAddAmenity} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-3 mt-4 rounded-xl font-bold uppercase tracking-widest hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200"
              >
                Deploy Facility
              </button>
            </form>
