  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow-sm border-b border-gray-200 px-8 py-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-blue-600 italic tracking-tighter uppercase">
          URBAN_NEXUS
        </h1>
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="flex items-center text-gray-500 hover:text-red-600 transition-colors text-sm font-medium uppercase italic"
          >
