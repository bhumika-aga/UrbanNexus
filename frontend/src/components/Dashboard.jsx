    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <nav className="bg-white shadow-sm border-b border-gray-200 px-8 py-4 flex justify-between items-center">
                <h1 className="text-xl font-bold text-blue-600 italic tracking-tighter">URBAN_NEXUS</h1>
                <div className="flex items-center space-x-4">
                    <span className="text-xs font-mono uppercase tracking-widest px-3 py-1 bg-gray-100 rounded-full text-gray-500">
                        {userRole}
                    </span>
            ...
            <main>
                ...
                {userRole === 'Technician' && <div className="p-8 font-mono">PITTING FOR SERVICE: VIEW COMING SOON</div>}
            </main>
        </div>
    );
}