  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <h2 className="text-lg font-bold text-gray-800 italic uppercase">
          Resident Directory
        </h2>
        ...
        <button
          ...
          className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center space-x-2"
        >
          ...
          {residents.map((res) => (
            ...
            >
              ...
              <td className="px-6 py-4 text-right">
                <button
                  onClick={() => handleDelete(res.resident_id, res.name)}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-md p-8 relative">
            ...
            <h3 className="text-xl font-bold mb-6 italic uppercase">
              Register New Driver
            </h3>
            <form onSubmit={handleAdd} className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, house_block: e.target.value })
                  }
                />
                <input
                  type="text"
                  ...
                  className="p-2 border rounded-lg"
                  onChange={(e) =>
                    setFormData({ ...formData, house_floor: e.target.value })
                  }
                />
                <input
                  type="text"
                  ...
                  className="p-2 border rounded-lg"
                  onChange={(e) =>
                    setFormData({ ...formData, house_unit: e.target.value })
                  }
                />
              </div>
              <input
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, ownership_status: e.target.value })
                }
              >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      no_of_members: parseInt(e.target.value),
                    })
                  }
                />
              </div>
